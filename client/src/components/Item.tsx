                ...
                <label className="itemLabels">
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            setItem((prevState) => ({
                                ...prevState,
                                value: new AbilityData(item.value.name, item.value.group, Number(e.target.value), item.value.calculatedText)
                            }));
                        }}
                        readOnly={!props.editView}
                            ...
                            return (
                                <div key={listItem.name}>
                                    <input
                                        ...
                                        placeholder="Name"
                                    />
                                    <input value={listItem.desc} onChange={() => {}} placeholder="Desc" />
                                </div>
                            );
                        })}
                    </div>
