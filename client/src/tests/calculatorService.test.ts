    ...
    const abilityData = new Map([
        [
            ...
            new AbilityData(
                ...
                "Group",
                0,
                "18[PB Base] +3[Age] +24[Enhancement, Maximized Beauty's Caress] +4[Sacred, Inner Beauty]  +5[Morale, Encouraging Snowsong] +6[Horseshoes of Flame]"
            )
        ]
    ]);
...
test("can calculate simple set reference", () => {
    //arrange
    const abilityData = new Map([["Dex", new AbilityData("Dex", "Group", 0, "2 SET20[inset Jar] +2")]]);
    const calculatorService = new CalculatorService();
...
test("can calculate double set reference", () => {
    //arrange
    const abilityData = new Map([["Dex", new AbilityData("Dex", "Group", 0, "2 SET20[inset Jar] +2 SET1")]]);
    const calculatorService = new CalculatorService();
...
test("can handle null values", () => {
    //arrange
    const abilityData = new Map([["Con", new AbilityData("Con", "Group", 0, "—[Necropolitan]")]]);
    const calculatorService = new CalculatorService();
...
test("can handle advanced null values", () => {
    //arrange
    const abilityData = new Map([["Con", new AbilityData("Con", "Group", 0, "10[Base] -6[Age] SET—[Necropolitan]")]]);
    const calculatorService = new CalculatorService();
...
test("can handle empty value", () => {
    //arrange
    const abilityData = new Map([["Str", new AbilityData("Str", "Group", 0, "")]]);
    const calculatorService = new CalculatorService();
