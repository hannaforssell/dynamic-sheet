...
export const defaultSheetPF: ICharacterSheet = {
  ...
  abilityData: new Map([
    ...
    ["Speed (Land)", new AbilityData("Speed (Land)", DataGroupType.AC, 0)],
    ...
    ["Melee To Hit", new AbilityData("Melee To Hit", DataGroupType.Offense)],
    ["Ranged To Hit", new AbilityData("Ranged To Hit", DataGroupType.Offense)],
    ...
    [
      "Knowledge (Arcana)",
      new AbilityData("Knowledge (Arcana)", DataGroupType.Skills),
    ],
    [
    ...
    ["Lucid Dreaming", new AbilityData("Lucid Dreaming", DataGroupType.Skills)],
    ...
    ["Sense Motive", new AbilityData("Sense Motive", DataGroupType.Skills)],
    ["Slight of Hand", new AbilityData("Slight of Hand", DataGroupType.Skills)],
